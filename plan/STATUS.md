...
| P12-01 | stdlib WebSocket 미니 클라이언트 | codex | — | ANY | AWAITING-REVIEW | plan/reports/P12-01-r1.md | |
| P12-02 | 브라우저 CDP 어댑터 + chrome-debug.bat | codex | P12-01 | ANY | BLOCKED | | |
| P12-03 | CDP 실측 + available 전환 | codex | P12-02 | CHROME | BLOCKED | | |
| P13-01 | approval(승인 게이트) + audit(감사 로그) 모듈 | codex | — | ANY | AWAITING-REVIEW | plan/reports/P13-01-r1.md | |
| P13-02 | `work` 오케스트레이터 subcommand E2E | codex | P13-01 | ANY | BLOCKED | | |
