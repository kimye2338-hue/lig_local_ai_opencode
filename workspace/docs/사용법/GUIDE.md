...
- **전공 지식은 이미 들어 있다**: 구조·진동·피로·열유체·기계요소·공작법·CNC·치구·GD&T·
  유도탄설계·데이터처리·금속규격·MIL-STD-810H·문서작성을 전공 교과서 수준으로 내장했다.
  관련 질문을 하면 해당 부분이 자동으로 근거로 붙어 "교수처럼" 답한다(재료·규격 수치는
  원문 확인을 함께 안내). 이건 개인 기억과 별개인 **레퍼런스 지식**이라 늘 그대로 신뢰 가능.
