...
COMMAND_ITEMS = [
    ...
    _item("command", "self-improve", ["workspace/agent_ops/agentops.py", "workspace/.opencode/commands/self-improve.md", "workspace/agent_ops/self_improvement.py"],
          "auto", "memory:self_improvement", "Automatic failure-to-fix learning loop; command is only for status/on/off/report.",
          "USERDATA append only, default auto-on"),
